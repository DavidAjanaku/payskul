...
export default function WhoCanApply({title, description}) {
  return (
    <div>
      <div className="border-purple-600 w-full h-[500px] md:h-80 md:max-w-xs rounded-3xl border-[1px] relative overflow-hidden ">
        <div className="flex flex-col h-full">
          <div className="flex flex-col p-3  pb-5  h-[100px] text-sm">
